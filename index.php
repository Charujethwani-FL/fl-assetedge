...
<body>
    ...
    <section class="hero-home-sec" id="homehero">
        <div class="home-form">
          <form class="home-form-container" id="homeForm" method="POST" >
    ...
    <div class="our-partner-container">
      ...
      <div class="partners-grid-container">
        <ul class="our-partner-grid row our-partner-border ">
          ...
          <li class="col-4 col-md-2 our-partner-item">
            <a href="#"><img src="public/partners/olx.jpg" alt="partner" /></a>
          </li>

          <li class="col-4 col-md-2 our-partner-item">
            <a href="#"><img src="public/partners/cardekho.jpg" alt="partner" /></a>
          </li>

          <li class="col-4 col-md-2 our-partner-item">
            <a href="#"><img src="public/partners/dsv.jpg" alt="partner" /></a>
          </li>
          <li class="col-4 col-md-2 our-partner-item">
            <a href="#"><img src="public/partners/filipkart.jpg" alt="partner" /></a>
          </li>
          ...
          <li class="col-4 col-md-2 our-partner-item">
            <a href="#"><img src="public/partners/hdfc.jpg" alt="partner" /></a>
          </li>
          <li class="col-4 col-md-2 our-partner-item">
            <a href="#"><img src="public/partners/panasonic.jpg" alt="partner" /></a>
          </li>
