...
?>
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-003">
            <img src="public/inventory/property/ucp.jpg" />
            <div class="properties-card__info">
              <h3>Unitech Cyber Park</h3>
              <p class="propertycard-location">
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>7,800 <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-004">
            <img src="public/inventory/property/mgp.jpg" />
            <div class="properties-card__info">
              <h3>Magnum Global Park</h3>
              <p class="propertycard-location">
                <span class="material-symbols-outlined">
                  location_on
                </span>
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>2,800 to 4,900 <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-005">
            <img src="public/inventory/property/mcc.jpg" />
            <div class="properties-card__info">
              <h3>Magnum City Centre </h3>
              <p class="propertycard-location">
                <span class="material-symbols-outlined">
                  location_on
                </span>
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>6,927 Dbl Ht <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-006">
            <img src="public/inventory/property/mcc.jpg" />
            <div class="properties-card__info">
              <h3>Magnum City Centre</h3>
              <p class="propertycard-location">
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>2,694 <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-007">
            <img src="public/inventory/property/mt.webp" />
            <div class="properties-card__info">
              <h3>Magnum Tower</h3>
              <p class="propertycard-location">
                <span class="material-symbols-outlined">
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>3,860 <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-008">
            <img src="public/inventory/property/mt.webp" />
            <div class="properties-card__info">
              <h3>Magnum Tower</h3>
              <p class="propertycard-location">
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>11,000 <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-009">
            <img src="public/inventory/property/m3m.jpg" />
            <div class="properties-card__info">
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>9,897 <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-010">
            <img src="public/inventory/property/abc.jpg">
            <div class="properties-card__info">
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>4,000 <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-011">
            <img src="public/inventory/property/aiplSign.avif" />
            <div class="properties-card__info">
              <h3>AIPL Signature</h3>
              <p class="propertycard-location">
                <span class="material-symbols-outlined">
                  location_on
                </span>
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>11,000 to 25,000 <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-012">
            <img src="public/inventory/property/spectower.webp" />
            <div class="properties-card__info">
              <h3>Splendor Spectrum Tower 1</h3>
              <p class="propertycard-location">
                <span class="material-symbols-outlined">
                  location_on
                </span>
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>9,896 <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-013">
            <img src="public/inventory/property/Casa.jpg" />
            <div class="properties-card__info">
              <h3>Casa Picasso</h3>
              <p class="propertycard-location">
                <span class="material-symbols-outlined">
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-014">
            <img src="public/inventory/property/M3M-IFC.jpg" />
            <div class="properties-card__info">
              <h3>M3M IFC</h3>
              <p class="propertycard-location">
                <span class="material-symbols-outlined">
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>16,500 <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-015">
            <img src="public/inventory/property/ib.jpg" />
            <div class="properties-card__info">
              <h3>Independent Building(Udyog Vihar, Phase 4)</h3>
              <p class="propertycard-location">
                <span class="material-symbols-outlined">
                  location_on
                </span>
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>50,000 <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
        ...
        <a href="inventory-detail.html" class="properties-card-link">
          <div class="properties-card" data-id="prop-016">
            <img src="public/inventory/property/emaar.jpg" />
            <div class="properties-card__info">
              <h3>Emaar Colonnade</h3>
              <p class="propertycard-location">
                <span class="material-symbols-outlined">
                  location_on
                </span>
              ...
              <div class="area-container">
                <h3>Total Area</h3>
                <span>16,000 <span class="sq-ft">Sq.Ft.</span></span>
              </div>
              <div class="decription-list">
                <p class="property-descrip">
                  A spacious and well-designed residential property offering comfort, convenience, and contemporary
